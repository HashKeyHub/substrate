...
use sp_state_machine::{
	...
	read_child_proof_check, ClonableSpawn,
};
...
impl<E, H, B: BlockT, S: BlockchainStorage<B>> LightDataChecker<E, H, B, S> {
	...
	pub fn new(blockchain: Arc<Blockchain<S>>, executor: E, spawn_handle: Box<dyn ClonableSpawn>) -> Self {
		Self {
...
pub mod tests {
	...
	use substrate_test_runtime_client::{
		...
		runtime::{self, Hash, Block, Header, Extrinsic}, local_task_executor,
	};
